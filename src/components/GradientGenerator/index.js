...
class GradientGenerator extends Component {
  ...
  onGenerate = () => {
    const {activeGradientDirection, toColorInput, fromColorInput} = this.state
    this.setState({
      gradientValue: `${activeGradientDirection} ${fromColorInput} ${toColorInput}`,
    })
  }
    ...
    return (
      ...
      >
        <ResponsiveContainer>
          ...
          <GradientDescription>Choose Direction</GradientDescription>
          <GradientDirectionList>
